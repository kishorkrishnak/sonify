...
const Album = ({ album }) => {
  ...
  return (
    <div className="grow flex items-center justify-center w-[100%] p-4 pb-6 bg-[#F6F6F6] dark:bg-[#212121] hover:bg-[#999999] dark:hover:bg-[#333333] rounded-md cursor-pointer">
      <div
